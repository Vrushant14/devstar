<script>
  ...
  function selectSlide(slideId) {
    ...
    document
      .querySelector(`.slide-item[data-slide-id="${slideId}"]`)
  ...
  function shareViaEmail() {
    ...
    const body = encodeURIComponent(
      `Hey there! I thought you might be interested in this presentation: ${presentationLink}`
    );
